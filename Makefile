...
PYTHON = python
CSV_FILE = quick_selection_data.csv lazy_selection_data.csv comparison_plots.png time_comparison_plots.png
...
$(TARGET): main.cpp quickselection.cpp quickselection.hpp lazyselection.cpp lazyselection.hpp
	$(CXX) $(CXXFLAGS) main.cpp quickselection.cpp lazyselection.cpp -o $(TARGET) $(LDFLAGS)
...
clean:
	rm -f $(TARGET) $(TEST_TARGET) $(CSV_FILE)
